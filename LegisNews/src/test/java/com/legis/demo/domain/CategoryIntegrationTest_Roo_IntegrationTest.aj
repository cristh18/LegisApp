...
import com.legis.demo.domain.CategoryIntegrationTest;
...
privileged aspect CategoryIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    CategoryDAO CategoryIntegrationTest.categoryDAO;
    ...
    public void CategoryIntegrationTest.testFind() {
        ...
        obj = categoryDAO.findOne(id);
        Assert.assertNotNull("Find method for 'Category' illegally returned null for id '" + id + "'", obj);
        Assert.assertEquals("Find method for 'Category' returned the incorrect identifier", id, obj.getId_());
    }
    ...
    public void CategoryIntegrationTest.testFindEntries() {
        ...
        List<Category> result = categoryDAO.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    public void CategoryIntegrationTest.testSaveUpdate() {
        ...
        boolean modified =  dod.modifyCategory(obj);
        Integer currentVersion = obj.getVersion();
        Category merged = categoryDAO.save(obj);
        categoryDAO.flush();
    ...
    public void CategoryIntegrationTest.testSave() {
        ...
        Assert.assertNull("Expected 'Category' identifier to be null", obj.getId_());
        try {
        ...
        categoryDAO.flush();
        Assert.assertNotNull("Expected 'Category' identifier to no longer be null", obj.getId_());
    }
    ...
    public void CategoryIntegrationTest.testDelete() {
        ...
        categoryDAO.flush();
        Assert.assertNull("Failed to remove 'Category' with identifier '" + id + "'", categoryDAO.findOne(id));
    }
